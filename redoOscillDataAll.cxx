...
#include "redoOscillDataAll.h"

// Plot the data coming from the digitizer card reading the purity monitors



void redoOscillDataAll::RunLifetimeCalc(TString PrMFile){
...
//   leg->AddEntry(graph5,"anode noise","l");
  ...
  calc.CalculateLifetime(oscillData, 1);
  ...
  // Print out numbers
  TString outFileName = "Run"+runNumber+"."+sPrM+".LogData.csv";
  ofstream myfile;
  myfile.open(outFileName.Data());
  myfile << "[Data]\n";
  myfile << "Tagname,TimeStamp,Value\n";
  myfile << "UBOONE.PRM_DIODEPEAK_" << atoi(sPrM.Data()) << ".F_CV," << when.Data() << "," << 0 << "\n";
  myfile << "UBOONE.PRM_DIODETIME_" << atoi(sPrM.Data()) << ".F_CV," << when.Data() << "," << 0 << "\n";
  myfile << "UBOONE.PRM_DIODEBASE_" << atoi(sPrM.Data()) << ".F_CV," << when.Data() << "," << 0 << "\n";
  myfile << "UBOONE.PRM_CATHPEAK_" << atoi(sPrM.Data()) << ".F_CV," << when.Data() << "," << calc.CatPeak() << "\n";
  myfile << "UBOONE.PRM_CATHTIME_" << atoi(sPrM.Data()) << ".F_CV," << when.Data() << "," << calc.CatTime() << "\n";
  myfile << "UBOONE.PRM_CATHBASE_" << atoi(sPrM.Data()) << ".F_CV," << when.Data() << "," << calc.CatBase() << "\n";
  myfile << "UBOONE.PRM_ANODEPEAK_" << atoi(sPrM.Data()) << ".F_CV," << when.Data() << "," << calc.AnoPeak() << "\n";
  myfile << "UBOONE.PRM_ANODETIME_" << atoi(sPrM.Data()) << ".F_CV," << when.Data() << "," << calc.AnoTime() << "\n";
  myfile << "UBOONE.PRM_ANODEBASE_" << atoi(sPrM.Data()) << ".F_CV," << when.Data() << "," << calc.AnoBase() << "\n";
  myfile << "UBOONE.PRM_ANODERISE_" << atoi(sPrM.Data()) << ".F_CV," << when.Data() << "," << calc.AnoRise() << "\n";
  myfile << "UBOONE.PRM_CATHFACTOR_" << atoi(sPrM.Data()) << ".F_CV," << when.Data() << "," << calc.CathF() << "\n";
  myfile << "UBOONE.PRM_ANODEFACTOR_" << atoi(sPrM.Data()) << ".F_CV," << when.Data() << "," << calc.AnoF() << "\n";
  myfile << "UBOONE.PRM_ANODETRUE_" << atoi(sPrM.Data()) << ".F_CV," << when.Data() << "," << calc.AnoTrue() << "\n";
  myfile << "UBOONE.PRM_CATHTRUE_" << atoi(sPrM.Data()) << ".F_CV," << when.Data() << "," << calc.CatTrue() << "\n";
  myfile << "UBOONE.PRM_LIFETIME_" << atoi(sPrM.Data()) << ".F_CV," << when.Data() << "," << calc.Lifetime() << "\n";
  myfile << "UBOONE.PRM_IMPURITIES_" << atoi(sPrM.Data()) << ".F_CV," << when.Data() << "," << calc.Impurities() << "\n";
  myfile.close();
